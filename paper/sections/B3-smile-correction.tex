...
$\gamma = \omega([\hat{X}, \hat{P}]_+) > 0$ (per Remark~\ref{rem:skew-sign}) is
the skew coefficient, and $\beta = \omega(\hat{X}^2)$ is the convexity
coefficient.
\end{theorem}

\begin{proof}
The proof extends Theorem~\ref{thm:effective-vol} to second order in
...
\subsection{Calibration of Convexity Parameter $\beta$}
